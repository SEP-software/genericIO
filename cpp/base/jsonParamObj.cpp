...
int jsonParamObj::getInt(const std::string arg){
    int x;
...
int jsonParamObj::getInt(const std::string arg, const int def){
   int x=jsonArgs->get(arg,def).asInt();
   return x;
}
   
float jsonParamObj::getFloat(const std::string arg, const float def){
  float x;
  x= jsonArgs->get(arg,def).asFloat();
  return x;

}
float jsonParamObj::getFloat(const std::string arg){
  float x;
 if((*jsonArgs)[arg].isNull())  
      error(std::string("trouble grabbing parameter ")+arg+std::string(" from parameters"));
...
std::string jsonParamObj::getString(const std::string arg, const std::string def){

  return  jsonArgs->get(arg,def).asString();

}
 
bool jsonParamObj::getBool(const std::string arg,  bool def){
 return  jsonArgs->get(arg,def).asBool();
}
bool jsonParamObj::getBool(const std::string arg){
  if((*jsonArgs)[arg].isNull())  
      error(std::string("trouble grabbing parameter ")+arg+std::string(" from parameters"));
...
std::vector<int> jsonParamObj::getInts(const std::string arg,int nvals){
   if((*jsonArgs)[arg].isNull())  
    error(std::string("trouble grabbing parameter ")+arg+std::string(" from parameters"));
...
std::vector<int> jsonParamObj::getInts(const std::string arg,std::vector<int> defs){
  std::vector<int> x;
   if((*jsonArgs)[arg].isNull())  {
...
std::vector<float> jsonParamObj::getFloats(const std::string arg,int nvals){
  if((*jsonArgs)[arg].isNull())    
    error(std::string("trouble grabbing parameter ")+arg+std::string(" from parameters"));
  const Json::Value vals = (*jsonArgs)[arg];
...
std::vector<float> jsonParamObj::getFloats(const std::string arg,std::vector<float> defs){
  std::vector<float> x;
   if((*jsonArgs)[arg].isNull())   {
     for(int i=0; i < defs.size(); i++) x.push_back(defs[i]);
  }
...
void jsonParamObj::error(const std::string errm){
